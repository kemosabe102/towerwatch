...
def test_ookla_ok_parses_speeds():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(FakeCompletedProcess(stdout=raw, returncode=0)),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_nonzero_returncode_returns_failure():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(FakeCompletedProcess(stdout=raw, returncode=1)),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_json_decode_error_returns_failure():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(FakeCompletedProcess(stdout="not json", returncode=0)),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_timeout_returns_failure():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(subprocess.TimeoutExpired("speedtest", 120)),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_missing_download_key_returns_failure():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(FakeCompletedProcess(stdout=bad_json, returncode=0)),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_file_not_found_returns_failure():
    ...
    result = ookla_mod.run_speedtest(
        subprocess_run=FakeSubprocess(FileNotFoundError("speedtest not found")),
        loki=FakeLoki(),
        server_id=0,
        timeout_s=120,
        binary="speedtest",
...
def test_ookla_server_id_included_in_cmd():
    ...
    runner = FakeSubprocess(FakeCompletedProcess(stdout=json.dumps(data), returncode=0))
